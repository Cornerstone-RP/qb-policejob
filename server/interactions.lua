RegisterNetEvent('police:server:SearchPlayer', function()
    ...
    if player ~= -1 and distance < 2.5 then
        ...
        exports['codem-inventory']:OpenInventoryById(src, tonumber(player))
...
RegisterNetEvent('police:server:SeizeCash', function(playerId)
    ...
    exports['codem-inventory']:AddItem(src, 'moneybag', 1, false, info, 'police:server:SeizeCash')
    TriggerClientEvent('codem-inventory:client:ItemBox', src, QBCore.Shared.Items['moneybag'], 'add')
...
RegisterNetEvent('police:server:RobPlayer', function(playerId)
    ...
    exports['codem-inventory']:OpenInventoryById(src, playerId)
