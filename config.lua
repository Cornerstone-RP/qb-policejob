...
Config.Locations = {
    ...
    vehicle = {
        vector4(-588.78125, -417.41558837891, 31.160305023193, 268.71737670898), -- LS
    },
    stash = {
        vector3(-606.43109130859, -418.40838623047, 35.17212677002), -- LS
    },
    impound = {
        vector3(-570.40368652344, -448.01962280273, 34.141387939453), -- LS
    },
    helicopter = {
        vector4(-595.95361328125, -431.2028503418, 51.384113311768, 179.9608001709), -- LS
    },
    trash = {
        vector3(-588.17065429688, -425.93322753906, 35.171905517578), -- LS
    },
    fingerprint = {
        vector3(-582.96325683594, -447.7102355957, 31.160284042358), -- LS
        vector3(-570.08264160156, -447.88781738281, 31.156078338623), -- LS
    },
    evidence = {
        vector3(0, 0, 0), -- LS
        vector3(0, 0, 0), -- LS
    ...
    stations = {
        { label = 'Los Santos Police Station', coords = vector4(-590.52917480469, -423.24591064453, 35.171897888184, 91.406890869141) }, -- LS
